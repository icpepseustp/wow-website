...
import estenzo from "../images/estenzo.png";
import cagampang from "../images/cagampang.png";
import sieras from "../images/sieras.png";
import telen from "../images/telen.png";
import dacay from "../images/dacay.png";
import bergado from "../images/bergado.png";
import garruncha from "../images/garruncha.png";
import nalupa from "../images/nalupa.png";
import fernandez from "../images/fernandez.png";
import mabulay from "../images/mabulay.png";
import jementiza from "../images/jementiza.png";
import oche from "../images/oche.png";

export const Faculty = () => {
  return (
  <div className="min-h-screen flex items-center">
  <div className="flex-1 max-w-screen mx-auto p-20 bg-gradient-to-b from-[#E5FFF7] to-[#8EC1F7] rounded-lg">
    <ul className="space-y-4 gap-4 md:gap-8 cursor-default">
      ...
      <li>
        <div className="flex flex-col max-w-8xl mx-auto p-10 items-center text-center justify-center">
          ...
          width={150}
          />
          <p className="text-sm md:text-xl lg:text-2xl font-poppins font-normal text-secondary font-bold">
    ...
    <ul className="mt-5 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 md:gap-5 cursor-default">
      ...
      <div className="flex flex-col max-w-8xl mx-auto p-10 items-center text-center justify-center">
          ...
          width={120}
          />
          <p className="text-sm md:text-base lg:text-lg font-poppins font-normal text-secondary font-bold">
      ...
      <div className="flex flex-col max-w-8xl mx-auto p-10 items-center text-center justify-center">
          ...
          />
          <p className="text-sm md:text-base lg:text-lg font-poppins font-normal text-secondary font-bold">
            Engr. Sprinztsie Maye Garruncha
          </p>
          <p className="text-sm lg:text-base font-poppins font-normal text-secondary italic">
            Instructor
          </p>
